...
class MainWindow(QMainWindow):
    ...
    def create_status_bar(self):
        ...
        status_bar.showMessage(f"当前用户: {self.user['username']} ({'管理员' if self.user['role'] == 'admin' else '操作员'})")
    ...
    def handle_backup(self):
        try:
            ...
            QMessageBox.information(self, "备份成功", f"数据备份成功！\n备份文件: {backup_path}")
    ...
    def handle_restore(self):
        ...
        backup_paths = [b['path'] for b in backup_list]
        ...
        if backup_path:
            ...
            if confirm == QMessageBox.StandardButton.Yes:
                try:
                    ...
                    QMessageBox.information(self, "恢复成功", "数据恢复成功！请重启应用")
    ...
    def handle_about(self):
        QMessageBox.information(self, "关于", "极简库存管理系统 v1.0.0\n\n专为小微企业和小型仓库设计的单机轻量化库存管理工具。")
